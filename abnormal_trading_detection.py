...
pro_data = pd.read_excel('https://raw.githubusercontent.com/wangyouqing0416/final-project_wyq/tree/main/data/process_data.xlsx',dtype={'Stock_Code': str})
fx_data=pd.read_excel('https://raw.githubusercontent.com/wangyouqing0416/final-project_wyq/tree/main/data/data_results.xlsx',dtype={'Stock_Code': str})
...
def generate_input_from_excel():
    df = pd.read_excel('https://raw.githubusercontent.com/wangyouqing0416/final-project_wyq/tree/main/data/data_results.xlsx').drop(['anomaly', 'Date', 'Stock_Code', 'Stock_Name','Short_Selling_Sold_Volume_10K_Shares','Short_Selling_Repurchased_Volume_10K_Shares',
