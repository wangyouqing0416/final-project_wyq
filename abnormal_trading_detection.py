...
if selected == "About":
    ...
    st.image("first page.jpg", caption="What's the margin trading ?", use_column_width=True)
    st.markdown("[Click here！！ You will jump to the source data URL~](https://data.eastmoney.com/rzrq/detail/all.1.2024-01-02.html)")
