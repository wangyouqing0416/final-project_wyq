...
pro_data = pd.read_excel('./data/process_data.xlsx',dtype={'Stock_Code': str})
fx_data=pd.read_excel('./data/data_results.xlsx',dtype={'Stock_Code': str})
...
def generate_input_from_excel():
    df = pd.read_excel('./data/data_results.xlsx').drop(['anomaly', 'Date', 'Stock_Code', 'Stock_Name','Short_Selling_Sold_Volume_10K_Shares','Short_Selling_Repurchased_Volume_10K_Shares',
...
if selected == "About":
    ...
    <div style="text-align: center;">
        ...
        <p>What's the margin trading and short selling ?</p>
    </div>
    """,
